    ...
    <body>
        ...
        <script>
            ...
            function loop() {{
                ...
                ctx.fillText("📡 SWARM MONITOR: [" + engineStatus + "]", 20, 30);
                ctx.fillStyle = '#00E5FF';
                ctx.fillText("📦 NODE DATA: " + totalScraped + " CACHED | ⚡ BUFFER: " + bufferSize + " TARGETS", 20, 50);
        ...
        <script>
            ...
            function loop() {{
                ...
                mappedNodes.forEach((node) => {{
                    ...
                    ctx.lineWidth = 2;
                    st.strokeRect = ctx.strokeRect(node.x - 25, node.y - 15, 50, 30);
                ...
                ctx.fillText("🕸️ NETWORK DISCOVERY TRACE ROUTE", 20, 30);
                requestAnimationFrame(loop);
            }}
            loop();
        </script>
